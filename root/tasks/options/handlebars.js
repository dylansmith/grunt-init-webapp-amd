...
module.exports = {
    options: {
        ...
        partialRegex: /./,                  // This option accepts a regex that defines the prefix character that is used to identify Handlebars partial files.
        partialsPathRegex: /partials\/./,   // This option accepts a regex that defines the path to a directory of Handlebars partials files.
    ...
    build: {
        files: {
          'src/bundles/templates.js': ['src/templates/**/*.hbs']
        }
    }
};
